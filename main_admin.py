...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        edit_menu = menubar.addMenu('Управление пользователями')
        manage_menu = menubar.addMenu('Управление доступом')
        ...
        manage_menu.addAction(add_faculty_action)
        manage_menu.addAction(add_division_action)
        manage_menu.addAction(manage_accounts_action)
